...
export class MasterdetailsComponent implements OnInit {
  ...
  constructor(private tmlistitemsService: TmlistitemsService) { 
    ...
    this.tg.columnDefs = allMasDetColDef;
  ...
  onBtnIncludeAllColumns() {      
    this.tg.gridApi.setColumnDefs([]); //to vacent previous columns
