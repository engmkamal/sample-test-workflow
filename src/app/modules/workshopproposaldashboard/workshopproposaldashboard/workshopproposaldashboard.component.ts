...
@Component({
  selector: 'app-workshopproposaldashboard',
  templateUrl: './workshopproposaldashboard.component.html',
  styleUrls: ['./workshopproposaldashboard.component.scss']
})
export class WorkshopproposaldashboardComponent implements OnInit { 
  ...
  ngOnInit() { 
    ...
    this.listInfo.select = 'Status' + "," + 'EmployeeID'+ "," + 'GUID' + "," + 'Modified' + "," + 'Created' + "," + 'PendingWith/ID' + "," + 'PendingWith/Title' + "," + 'Author/ID' + "," + 'Author/Title' + "," + 'ID' + "," + 'Title'+","+'Author/Office'+","+'Author/JobTitle'+","+'TotalEstimatedAmount';
...
let myProcessColDef = [
  ...
  },
  {
    ...
    cellRenderer: function(params) {
      return '<a href="https://portal.bergerbd.com/leaveauto/SitePages/WorkshopProposal.aspx?UniqueId='+params.value+'&mode=read" target="_blank">View</a>'
    },
    enableRowGroup: false,
