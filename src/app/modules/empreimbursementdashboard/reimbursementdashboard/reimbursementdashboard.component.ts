...
// @Component({
//   selector: 'app-reimbursementdashboard',
//   templateUrl: './reimbursementdashboard.component.html',
//   styleUrls: ['./reimbursementdashboard.component.scss']
// })
...
export class ReimbursementdashboardComponent implements OnInit { 
  ...
  constructor(
    ...
    private http: HttpClient) { 
      ...
      this.frameworkComponents = { myDetailCellRenderer: EmpreimbursementdetailrenderedComponent };
      //----------master details ends ---
  ...
  ngOnInit() { 
    ...
    this.listInfo.select = 'Title'+","+'Status'+","+'GUID'+","+'Modified'+","+'PendingWith/ID'+","+'PendingWith/Title'+","+'Author/ID'+","+'Author/Title'+","+'Entitlement'+","+'GLCode'+","+'CostCenter'+","+'Created'+","+'TotalReimbursementAmount'+","+'EmployeeId'+","+'ID'+","+'Author/Office'+","+'ItemName';
