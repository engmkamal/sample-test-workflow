...
@Component({
  selector: 'app-provisionforxpensesmstr',
  templateUrl: './provisionforxpensesmstr.component.html',
  styleUrls: ['./provisionforxpensesmstr.component.scss']
})



export class ProvisionforxpensesmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "ProvisionForExpensesInfoList";
...
},
{
  ...
  cellRendererFramework: ProvforexvwbtncstmComponent,
  enableRowGroup: false,
