...
import { LiActionBtnCstmComponent } from '../../WorkshopProposal/li-action-btn-cstm/li-action-btn-cstm.component';
...
@Component({
  selector: 'app-workshopproposalmstr',
  templateUrl: './workshopproposalmstr.component.html',
  styleUrls: ['./workshopproposalmstr.component.scss']
})



export class WorkshopproposalmstrComponent implements OnInit { 
