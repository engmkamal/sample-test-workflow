...
@Component({
  selector: 'app-supplybudgetexpensemstr',
  templateUrl: './supplybudgetexpensemstr.component.html',
  styleUrls: ['./supplybudgetexpensemstr.component.scss']
})



export class SupplybudgetexpensemstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "SupplementaryBudgetExpense";
...
},
{
  ...
  cellRendererFramework: SuplyexpensevwbtncstmComponent,
  enableRowGroup: false,
