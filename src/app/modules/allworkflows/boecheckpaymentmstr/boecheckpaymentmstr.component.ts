...
@Component({
  selector: 'app-boecheckpaymentmstr',
  templateUrl: './boecheckpaymentmstr.component.html',
  styleUrls: ['./boecheckpaymentmstr.component.scss']
})



export class BoecheckpaymentmstrComponent implements OnInit { 
  ...
  constructor(private sharepointlistService:SharepointlistService) { 
    ...
    this.mpTG.frameworkComponents = {
      ...
      //customizedAgeCell: viewFABtnObj,
    }
    //--------for action btn link rendering start -------
  ...
  ngOnInit() { 
    this.listInfo.name = "BOECheckPaymentProcessInfo";
...
let myProcessColDef = [
  ...
  },
  {
    ...
    field: 'GUID',
    //cellRendererFramework: MyprocessviewbtncstmComponent,
    cellRendererFramework: BoechqpaymentvwbtncstmComponent,
    enableRowGroup: false,
