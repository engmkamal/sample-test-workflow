...
@Component({
  selector: 'app-poolcarrequisition',
  templateUrl: './poolcarrequisition.component.html',
  styleUrls: ['./poolcarrequisition.component.scss']
})



export class PoolcarrequisitionComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "PoolCarRequisitionInfo";
...
},
{
  ...
  cellRendererFramework: PoolcarvwbtncstmComponent,
  enableRowGroup: false,
