...
@Component({
  selector: 'app-freefgmstr',
  templateUrl: './freefgmstr.component.html',
  styleUrls: ['./freefgmstr.component.scss']
})



export class FreefgmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "FreeFGRequests";
...
},
{
  ...
  cellRendererFramework: FrefgvwbtncstmComponent,
  enableRowGroup: false,
