...
@Component({
  selector: 'app-fixedassetacquisitionmstr',
  templateUrl: './fixedassetacquisitionmstr.component.html',
  styleUrls: ['./fixedassetacquisitionmstr.component.scss']
})



export class FixedassetacquisitionmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "FixedAssetAcquisitionInfo";
    ...
    //let listName = "AssetDisposalInfo";
    //let queryParameter = 
...
},
{
  ...
  cellRendererFramework: FxdassetvwbtncstmComponent,
  enableRowGroup: false,
