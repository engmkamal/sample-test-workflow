...
@Component({
  selector: 'app-fbptrackermstr',
  templateUrl: './fbptrackermstr.component.html',
  styleUrls: ['./fbptrackermstr.component.scss']
})



export class FbptrackermstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "FBPTrackerInfo";
...
},
{
  ...
  cellRendererFramework: FbptrackervwbtncstmComponent,
  enableRowGroup: false,
