...
@Component({
  selector: 'app-hrservicemstr',
  templateUrl: './hrservicemstr.component.html',
  styleUrls: ['./hrservicemstr.component.scss']
})



export class HrservicemstrComponent implements OnInit { 
...
},
{
  ...
  cellRendererFramework: HrservicevwbtncstmComponent,
  enableRowGroup: false,
