...
@Component({
  selector: 'app-securityincidencemstr',
  templateUrl: './securityincidencemstr.component.html',
  styleUrls: ['./securityincidencemstr.component.scss']
})



export class SecurityincidencemstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "SecurityIncidence";
...
},
{
  ...
  cellRendererFramework: SecincidencevwbtncstmComponent,
  enableRowGroup: false,
