...
@Component({
  selector: 'app-vendorcomplaintmstr',
  templateUrl: './vendorcomplaintmstr.component.html',
  styleUrls: ['./vendorcomplaintmstr.component.scss']
})



export class VendorcomplaintmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    ...
    let oldList ={
      name: "Vendor%20Complaint",
      query: 'ID'+","+'Status'+","+'GUID'+","+'Modified'+","+'Created'+","+'Author/ID'+","+'Author/Title', 
      expand: 'Author',
    };
    this.listInfo.name = "VendorComplain";
...
},
{
  ...
  cellRendererFramework: VendorcomplainvwbtncstmComponent,
  enableRowGroup: false,
