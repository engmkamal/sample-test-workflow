...
@Component({
  selector: 'app-emppaintdiscountmstr',
  templateUrl: './emppaintdiscountmstr.component.html',
  styleUrls: ['./emppaintdiscountmstr.component.scss']
})



export class EmppaintdiscountmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "EmpPaintDiscountRequest";
...
},
{
  ...
  cellRendererFramework: EmppaintdisviewbtncstmComponent,
  enableRowGroup: false,
