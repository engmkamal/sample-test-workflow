...
@Component({
  selector: 'app-changemanagementmstr',
  templateUrl: './changemanagementmstr.component.html',
  styleUrls: ['./changemanagementmstr.component.scss']
})



export class ChangemanagementmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "ChangeItems";
