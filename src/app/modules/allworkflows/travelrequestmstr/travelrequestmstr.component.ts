...
@Component({
  selector: 'app-travelrequestmstr',
  templateUrl: './travelrequestmstr.component.html',
  styleUrls: ['./travelrequestmstr.component.scss']
})



export class TravelrequestmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    ...
    //   expand: 'Author',
    // };
    // this.listInfo.name = "TravelRequests";
...
},
{
  ...
  //cellRendererFramework: TravelreqviewbtncstmComponent,
  enableRowGroup: false,
