...
@Component({
  selector: 'app-fundrequestmstr',
  templateUrl: './fundrequestmstr.component.html',
  styleUrls: ['./fundrequestmstr.component.scss']
})



export class FundrequestmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "FundRequestFromFieldInfoList";
...
},
{
  ...
  cellRendererFramework: FundrequestvwbtncstmComponent,
  enableRowGroup: false,
