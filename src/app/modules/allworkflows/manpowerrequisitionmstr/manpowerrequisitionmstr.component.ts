...
@Component({
  selector: 'app-manpowerrequisitionmstr',
  templateUrl: './manpowerrequisitionmstr.component.html',
  styleUrls: ['./manpowerrequisitionmstr.component.scss']
})



export class ManpowerrequisitionmstrComponent implements OnInit { 
  ...
  ngOnInit() { 
    this.listInfo.name = "ManpowerRequisitionInfo";
...
},
{
  ...
  cellRendererFramework: ManpowerreqvwbtncstmComponent,
  enableRowGroup: false,
