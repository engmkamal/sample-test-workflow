...
@Component({
  selector: 'app-mobilehandsetviewbtncstm',
  templateUrl: './mobilehandsetviewbtncstm.component.html',
  styleUrls: ['./mobilehandsetviewbtncstm.component.scss']
})
export class MobilehandsetviewbtncstmComponent implements OnInit {
