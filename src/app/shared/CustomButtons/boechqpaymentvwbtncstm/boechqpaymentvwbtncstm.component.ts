...
@Component({
  selector: 'app-boechqpaymentvwbtncstm',
  templateUrl: './boechqpaymentvwbtncstm.component.html',
  styleUrls: ['./boechqpaymentvwbtncstm.component.scss']
})
export class BoechqpaymentvwbtncstmComponent implements OnInit {
